...
const features = [
  ...
  },
  {
    ...
    description: (
      <>
        Built on a modern stack utilizing the best design practices that make it
        easy to jump in and make modifications.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        All servers run in isolated Docker containers that limit attack vectors,
        provide strict resource limits, and provide environments tailored to
        each specific game.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Pterodactyl is 100% free and licensed under a MIT license. All of our
        code is completely open source as well.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Save the furious clicking and screaming for Overwatch. Pterodactyl's
        interface is designed so well even Hanzo can use it.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Whether you're a hosting company, the next Hyplex, or just some dudes
        playing video games, we've got you covered.
      </>
    ),
  },
];
        ...
        <div className="container">
          ...
          <div className={styles.buttons}>
            ...
            <Link
              ...
              to={useBaseUrl("docs/project/introduction")}
            >
              Get Started
            </Link>
          </div>
